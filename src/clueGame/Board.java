...
public class Board extends JPanel {
	...
	public Board(String layoutFile, String legendFile, ArrayList<Player> p) throws FileNotFoundException, BadConfigFormatException {
		loadConfigFiles(layoutFile, legendFile);
		players = p;
		calcAdjacencies();
	}
	...
	public void determineAndSetDoorwayDirection(char aLetter, RoomCell aCell){
		...
		aCell.isDoor = true;
		break;
		case 'N' : aCell.setDoorDirection(RoomCell.DoorDirection.NONE);
		aCell.isDoor = false;
		aCell.isName = true;
		}	
